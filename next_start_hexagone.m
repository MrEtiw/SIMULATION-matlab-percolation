...
% Fonctionne pour une matrice dont les voisins sont définis commme étant
% des hexagones. 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function []=next_start_hexagone(indice,M, discovery_time)
...
if isempty(voisins_a_visiter)==1
    ...
    if time_avant>0 %donc que nous ne sommes pas à la case initiale
        ...
        prochain=precedent;
        next_start_hexagone(prochain,M,discovery_time); %on recall next_start sur l'endroit où on était avant
    else
        %fprintf('de retour au debut, pas de percolation\n')
        dlmwrite('resultat_verif_percol_6.txt','0');
    end
else
    ...
    if prochain>n*(n-1) %condition d'arrêt 
        ...
        dlmwrite('resultat_verif_percol_6.txt','1');
        ...
        next_start_hexagone(prochain,M,discovery_time);
    end
end
end